...
description: Use when creating AI digest images from Smart YouTube Reader archives — inspecting chapter image entries such as slice frame paths or source frame paths, deriving visual evidence from source pixels, and turning slides, screenshots, diagrams, or slide frames into source-agnostic image-generation briefs for novel generated WebP teaching images, without copying, cropping, tracing, branding, or reusing the original frames.
---
