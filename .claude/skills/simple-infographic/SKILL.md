...
description: Use when you need a quiet, text-led infographic card strip from product, service, workflow, onboarding, or digest content — a calm benefit carousel, buying/service explainer, support-options strip, or a generated static teaching image (e.g. a Smart YouTube Reader digest chapter) that should read as clear rather than cinematic, with white cards, restrained visuals, and no copied source branding or navigation controls.
---
