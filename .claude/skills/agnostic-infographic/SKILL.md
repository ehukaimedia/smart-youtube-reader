...
description: Use when designing, building, or prompting for brand-neutral premium infographic systems from raw content, screenshots, product/service facts, or design references — horizontal card carousels, feature explainers, purchasing-benefit cards, product discovery modules, comparison sections, or clean editorial UI infographics — without copying source brands, logos, protected product names, or proprietary wording. Provides the shared neutral card grammar underneath simple-infographic and premium-infographic.
---
