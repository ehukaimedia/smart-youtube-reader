...
Ehukai Media redistributes this skill under `skills/impeccable/` in Smart YouTube Reader. Some template variables were resolved for this repository's local skill path and command style.
