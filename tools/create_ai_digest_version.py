...
def build_agent_task(source_dir: Path, with_images: bool = False) -> str:
   ...
   - Premium style must use GPT 5.5 image generation for the bitmap visual, not local vector-only placeholders. Simple style may use generated or deterministic visuals as long as it passes the quality bar.
