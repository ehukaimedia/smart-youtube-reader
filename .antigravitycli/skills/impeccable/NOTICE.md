...
Ehukai Media redistributes this skill under `.antigravitycli/skills/impeccable/` in Smart YouTube Reader. Some template variables were resolved for this repository's Antigravity skill path and command style.
