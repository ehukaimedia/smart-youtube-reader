...
2. Add a digest service that can call the local Ollama Gemma digest agent and fall back to deterministic compaction only when explicitly selected.
...
11. Benchmark the local Ollama digest Modelfile against real archives before treating it as ready.
